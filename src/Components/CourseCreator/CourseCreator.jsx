                    ...
                    <DndContext onDragStart={handleDragStart} onDragEnd={handleDragEnd} modifiers={[restrictToWindowEdges]}>
                        <div className='slides_container'>
                            ...
                            <div className='pagination_addSlide_container'>
                                <div style={{ position: 'relative' }} className='pagination_container'>
                                    ...
                                    {
                                        selectedQuizId ? (<button className='cta__button' style={{ position: 'absolute', top: '5px', right: '20px' }} onClick={() => addQuestion()}>Add Question</button>) :
                                            (<button className='cta__button' style={{ position: 'absolute', top: '5px', right: '0px' }} onClick={() => addSlide()}>Add Slide</button>)
                                    }
                                </div>
                        ...
                        <div className='draggables_container'>
                            <div style={{ display: 'flex', flexDirection: 'column', gap: '1em', marginBottom: '1em', justifyContent: 'center', alignItems: 'center', marginBottom: '2em' }}>
                                {
                                    showPreview ? (
                                        <button className="cta__button" onClick={() => { setShowPreview((showPreview) => !showPreview) }}>Go Back</button>) : (
                                        <>
                                            <button onClick={handleSaveCourse} className="cta__button">Save Course</button>
                                            <button data-tooltip-id="my-tooltip" data-tooltip-content='Previews the current silde' data-tooltip-place="left-start" onClick={() => { setShowPreview((showPreview) => !showPreview); setPreviewIds(); }} className='cta__button'>Quick Preview</button>
