...
const CourseBuilder = () => {
  ...
  const [selectedChapterPreviewId, setSelectedChapterPreviewId] =
    useState(null);
  const [selectedSectionPreviewId, setSelectedSectionPreviewId] =
    useState(null);
  ...
  useEffect(() => {
    axios
      .get("http://localhost:3001/api/fetch-course-info", {
        params: {
          courseId: courseId,
        },
      })
  ...
  useEffect(() => {
    axios
      .get("http://localhost:3001/api/fetch-sidebar-data", {
        params: {
          courseId: courseId,
        },
      })
        ...
        {showPreview ? (
          ...
          <>
            <div className={toggle ? "active-sidebar" : "sidebar_container"}>
              ...
              >
                <Link to="/courses" onClick={handleAllCoursesClick}>
                  <button className="cta__button">
                    <span>
                      <i className="fa-solid fa-arrow-left-long icon__text"></i>
                    </span>{" "}
                    All Courses
                  </button>
                </Link>
